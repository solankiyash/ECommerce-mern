          ...
          <div className='row'>
            ...
            <div className='col-3'>
              ...
              <div className='footer-links d-flex flex-column'>
                <Link to="/Privercypolicy" className='text-white py-2 mb-1'>Privacy Policy</Link>
                ...
                <Link to="/TearmandCondition" className='text-white py-2 mb-1'>Terms & Conditions</Link>
